...
BEGIN { %dir_list = (
			...
			"SummaryData_dict" => "larcore_SummaryData_dict",
        		...
        		"RawData_utils" => "lardata_RawData_utils",
                        ...
                        "DetectorProperties_service" => "lardata_Utilities_DetectorProperties_service",
			...
			"LArProperties_service" => "lardata_Utilities_LArProperties_service",
			...
			"DatabaseUtil_service" => "lardata_Utilities_DatabaseUtil_service",
			"TimeService_service" => "lardata_Utilities_TimeService_service",
